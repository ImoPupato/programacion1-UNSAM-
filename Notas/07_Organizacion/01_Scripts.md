...
El diseño modular se refiere a la práctica de dividir un sistema en partes o módulos independientes que pueden ser desarrollados, probados y depurados de manera independiente. Cada módulo tiene una funcionalidad específica y puede interactuar con otros módulos a través de interfaces bien definidas.

En el contexto de la programación, una función es un ejemplo de un módulo. Una función bien diseñada realiza una tarea específica y puede ser utilizada en diferentes partes del programa sin necesidad de duplicar el código. Esto facilita la comprensión del código, su mantenimiento y su reutilización.

### Predecibilidad

La predecibilidad en el diseño de funciones se refiere a la capacidad de prever el comportamiento de una función basándose en sus entradas. Una función predecible siempre producirá el mismo resultado cuando se le proporcionen las mismas entradas, independientemente del estado global del programa. Esto se conoce como **transparencia referencial** y es una propiedad deseable en la programación funcional.

Una función predecible facilita la depuración y las pruebas, ya que su comportamiento puede ser verificado de manera aislada. Además, las funciones predecibles son más seguras de usar en programas concurrentes, ya que no dependen ni modifican el estado global del programa.

Para hacer que tus funciones sean predecibles, asegurate de que sólo dependan de sus parámetros y no de variables globales o del estado del programa.
...
En el [Ejercicio 4.11](../04_Datos/04_Formato.md#ejercicio-411-un-desafio-de-formato) (o el [Ejercicio 4.10](../04_Datos/04_Formato.md#ejercicio-410-agregar-encabezados)) escribiste un programa llamado `tabla_informe.py` que imprime un informe con el balance de compra y venta de frutas en un camión.

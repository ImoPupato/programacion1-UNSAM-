...
```bash
Bienvenido a Ubuntu 22.04.3 LTS (GNU/Linux 4.4.0)
...
A las líneas `joaco@paleo:~$` en Linux y `PS C:\Users\Joaco>` en Windows se las llama _command prompt_ en inglés y es la forma que tiene la terminal de decirte "yo te estoy esperando a vos". Te está _preguntando_ (_prompting_) lo que debe hacer.
...
`PS C:\Users\Joaco> unzip -l Downloads/Ejercicios.zip`
...
```PowerShell
PS C:\Users\Joaco> dir ejer*


    Directorio: C:\Users\Joaco


Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
d-----        21/09/2023     20:49                ejercicios_python
```

```powershell
PS C:\Users\Joaco> dir ejercicios_python/


    Directorio: C:\Users\Joaco\ejercicios_python


Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
d-----        21/09/2023     20:51                Clase01
d-----        21/09/2023     20:51                Clase02
d-----        21/09/2023     20:51                Clase03
d-----        21/09/2023     20:51                Clase04
d-----        21/09/2023     20:51                Clase05
d-----        21/09/2023     20:51                Clase06
d-----        21/09/2023     20:51                Clase07
d-----        21/09/2023     20:51                Clase08
d-----        21/09/2023     20:51                Clase09
d-----        21/09/2023     20:51                Clase10
d-----        21/09/2023     20:51                Clase11
d-----        21/09/2023     20:51                Data
-a----        14/03/2023     09:07            106 readme.txt
```
...
`PS C:\Users\Joaco\ejercicios_python\Clase01>`
...
```powershell
PS C:\Users\Joaco\ejercicios_python\Clase01> type readme.txt
...
Donde `nombredelarchivo` es el camino completo al archivo (fully qualified filename o ruta absoluta) por ejemplo `del c:/users/flacus/ejercicios_python/clase10/readme.txt`
...
```powershell
PS C:\Users\Joaco\ejercicios_python\Clase02> type readme.txt
```
...
```powershell
PS C:\Users\Joaco\ejercicios_python\Clase01> type C:\Users\Joaco\ejercicios_python\Clase02\readme.txt
```

Notar que estamos parados en `C:\Users\Joaco\ejercicios_python\Clase01` y nos estamos refiriendo al `readme.txt` que está en "el directorio de al lado" `C:\Users\Joaco\ejercicios_python\Clase02\`
...
```powershell
PS C:\Users\Joaco\ejercicios_python\Clase01> type ../Clase02/readme.txt
```

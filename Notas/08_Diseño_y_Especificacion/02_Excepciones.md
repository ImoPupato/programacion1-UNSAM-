...
Copiá el archivo `fileparse.py` al directorio de ejercicios de la clase actual. La última versión que deberías tener, es la correspondiente al [Ejercicio 7.6](../07_Organizacion/02_Funciones.md#ejercicio-76-trabajando-sin-encabezados).
